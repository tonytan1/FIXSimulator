...
import com.quickfix.simulator.pojo.Status;
...
public class FIXimulatorApplication extends MessageCracker implements Application {
    ...
    private volatile boolean ioiSenderStarted;
    ...
    public void onLogon(SessionID sessionID) {
        ...
        if (connectedStatus != null)
            connectedStatus = Status.RUNNING;
    }

    public void onLogout(SessionID sessionID) {
        connected = false;
        currentSession = null;
        connectedStatus = Status.STOPPED;
    }

    protected void onMessage(quickfix.fix42.IndicationofInterest message, SessionID sessionID)
    ...
    public void startIOIsender(Integer delay, String symbol, String securityID) {
        ...
        if (connected && ioiSenderStarted)
            ioiSenderStatus = Status.RUNNING;
    }
    ...
    public void stopIOIsender() {
        ...
        ioiSenderStatus = Status.STOPPED;
    }
